...
<head>
    ...
    <title>Forgot Password | Vishnu Blog</title>
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        ...
                                        <p class="mb-4">No problem, it happens. Just type below your email address and we will send you a password reset link soon!</p>
                                    </div>
                                    <div class="form-group">
                                        <input type="email" class="form-control form-control-user" id="exampleInputEmail" name="email" aria-describedby="emailHelp" placeholder="Type your email address...">
                                    </div>
                                ...
                                <div class="text-center">
                                    <a class="small" href="">Already have an account? Log In!</a>
                                </div>
                            </div>
                        </form>
                    </div>
