...
<head>
    ...
    <title>Log In | Vishnu Blog</title>
                            ...
                            <div class="p-5">
                                ...
                                <form class="user" method="POST" action="{{ route('password.update') }}">
                                    ...
                                    <div class="form-group">
                                        <input id="exampleInputEmail" type="email" class="form-control form-control-user @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus placeholder="Email address">
                                        @error('email')
